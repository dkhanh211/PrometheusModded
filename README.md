...
```batch
git clone https://github.com/dkhanh211/PrometheusModded.git
```

Alternatively you can download the Sources (Original) [here](https://github.com/prometheus-lua/Prometheus/archive/refs/heads/master.zip).
Alternatively you can download the Sources (Modded) [here](https://github.com/dkhanh211/PrometheusModded)
...
Full license text: [Prometheus License](https://github.com/dkhanh211/PrometheusModded/blob/main/LICENSE)
